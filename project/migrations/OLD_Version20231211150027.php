...
final class OLDVersion20231211150027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE topic (id INT AUTO_INCREMENT NOT NULL, user_proposer_id INT NOT NULL, user_reviewer_id INT DEFAULT NULL, user_presenter_id INT DEFAULT NULL, meetup_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, duration VARCHAR(255) DEFAULT NULL COMMENT \'(DC2Type:dateinterval)\', duration_category VARCHAR(255) DEFAULT NULL, current_place VARCHAR(255) NOT NULL, reviewed_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', published_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9D40DE1B18246FA1 (user_proposer_id), INDEX IDX_9D40DE1BD94C8F83 (user_reviewer_id), INDEX IDX_9D40DE1B5D28BA37 (user_presenter_id), INDEX IDX_9D40DE1B591E2316 (meetup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
